...
const extendedModes = [DeduplicationMode.Extended, DeduplicationMode.FastExtended];

for (const extendedMode of extendedModes) {
    describe(`Tests for ${extendedMode} comparison hars`, () => {
