...
var Configvolume = 
{
    ...
    get_product_license_url:'/servers/public/index.php?c=store&a=getproductlicense',
...
var  Controlvolume = 
{
    init : function()
    {
        ...
        $("#pc_name, #device_name, #prefix_licence_name").change(function()
        {
            ...
            $(".contact_rbox").hide();
            $.get(Configvolume.get_product_license_url, {pc_name : pc_name, device_name:device_name, prefix_licence_name:prefix_licence_name, pro_id:pro_id, currency:"EUR", action_type : action_type, site_id : site_id}, 
            function(data) 
            {
                if(data.price)
                {
